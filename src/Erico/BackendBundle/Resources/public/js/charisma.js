...
$(document).ready(function () {
    ...
    /*function switchTheme(themeName) {
        if (themeName == 'classic') {
            ...
            $('#bs-css').attr('href', 'bundles/ericobackend/bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', 'bundles/ericobackend/css/bootstrap-' + themeName + '.min.css');
        }
