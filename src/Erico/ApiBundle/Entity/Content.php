 ...
 * @ORM\DiscriminatorMap({"content"="Content", "paragraphe"="Erico\ApiBundle\Entity\Paragraphe", "texteloi"="Erico\ApiBundle\Entity\TexteLoi", "categorie"="Erico\ApiBundle\Entity\Categorie", "keyword"="Erico\ApiBundle\Entity\Keyword", "jurisprudence"="Erico\ApiBundle\Entity\Jurisprudence", "document"="Erico\ApiBundle\Entity\Document", "nature"="Erico\ApiBundle\Entity\Nature", "article"="Erico\ApiBundle\Entity\Article", "menu"="Erico\ApiBundle\Entity\Menu", "page"="Erico\ApiBundle\Entity\Page", "commentaire"="Erico\ApiBundle\Entity\Commentaire", "message"="Erico\ApiBundle\Entity\Message", "attribut"="Erico\ApiBundle\Entity\Attribut", "produit"="Erico\ApiBundle\Entity\Produit", "declinaison"="Erico\ApiBundle\Entity\Declinaison", "image"="Erico\ApiBundle\Entity\Image", "abonnement"="Erico\ApiBundle\Entity\Abonnement"})
 */
...
class Content
{
   ...
   $sans_accent = array('a', 'a', 'a', 'a', 'a', 'a', 'A', 'A', 'A', 'A', 'A', 'A', 'c', 'C', 'e', 'e', 'e', 'e', 'E', 'E', 'E', 'E', 'i', 'i', 'i', 'i', 'I', 'I', 'I', 'I', 'o', 'o', 'o', 'o', 'o', 'O', 'O', 'O', 'O', 'O', 'u', 'u', 'u', 'u', 'U', 'U', 'U', 'U', 'y', 'y', 'y', 'n', '-');      
     ...
     * Set user
     *
     * @param \Erico\ApiBundle\Entity\User $user
     *
     * @return Content
     */
    public function setUser(\Erico\ApiBundle\Entity\User $user = null)
    {
        $this->user = $user;
     ...
     * Get user
     *
     * @return \Erico\ApiBundle\Entity\User
     */
