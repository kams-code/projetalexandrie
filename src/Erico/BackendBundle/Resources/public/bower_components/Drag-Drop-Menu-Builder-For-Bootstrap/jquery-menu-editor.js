...
function MenuEditor(idSelector, settings) {
    ...
    $(document).on('click', '.btnEdit', function (e) {
		...
		$("#frmEdit :input:not('#target')").trigger('change');
    });
	...
	this.updateItem = function() {
        ...
        itemEdit.data('text', text);
		itemEdit.data('title', $("#mnu_title").val());
		itemEdit.data('typetarget', $("#mnu_typetarget").val());
        itemEdit.data('target', $("#mnu_target").val());
        itemEdit.data('href', $("#mnu_href").val());
   ...
   /*  function addItem() {
    ...
    function createMenu (arrayItem, depth) {
        ...
        $.each(arrayItem, function (k, v) {
            ...
            var $li = $('<li>');
            $li.attr('id', v.text);
            $li.addClass('list-group-item').data('text', v.text).data('icon', v.icon).data('title', v.title).data('typetarget', v.typetarget).data('target', v.target).data('href', v.href);
            var $div = $('<div>');
